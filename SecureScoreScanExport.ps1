...
$yourLogo = "https://wilroffreitsma.nl/wp-content/uploads/2021/04/wr-logo.png"
$TableHeaderColour = "#00a1f1"
$applicationName = "WilroffReitsma Secure Score Exporter"
...
$homePage = "https://wilroffreitsma.nl"
$appIdURI = "https://wilroffreitsma.nl/$((New-Guid).ToString())"
        ...
        do {
            try {
                ...
                if ($scores) {
                    ...
                    $scoreheading = "<h2>Microsoft Secure Score: $currentScore ($PercentageScore %)</h2>"
